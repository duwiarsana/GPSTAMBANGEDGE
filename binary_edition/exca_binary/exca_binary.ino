...
void handlePortalRoot() {
  String html = F("<!DOCTYPE html><html><head><meta charset='UTF-8'><meta name='viewport' content='width=device-width,initial-scale=1.0'>"
                  "<title>Setting & OTA Excavator</title>"
                  "<style>"
                  ...
                  "h2{margin-bottom:4px;color:#f59e0b;font-size:19px;}"
                  "p{font-size:12px;color:#94a3b8;margin-bottom:16px;}"
                  ".cur{background:#334155;padding:8px 12px;border-radius:8px;font-weight:bold;margin-bottom:16px;font-size:15px;color:#f59e0b;}"
  ...
  html += F("</div>"
            ...
            "<input type='text' name='id' maxlength='7' placeholder='contoh: EXCA516' required>"
            "<button type='submit' class='btn-amber'>💾 SIMPAN & REBOOT</button>"
            "</form></div>"
            "<div class='card'>"
